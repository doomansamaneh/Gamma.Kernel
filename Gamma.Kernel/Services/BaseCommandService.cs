...
public abstract class BaseCommandService<TAddCommandHandler, TAddCommand,
        TEditCommandHandler, TEditCommand,
        TDeleteCommandHandler, TDeleteCommand>(
